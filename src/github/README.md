...
The following command will generate a `.github/workflows/terragrunt-migrate.yml` file in your project:

```bash
fluentci gh init -t terragrunt_pipeline
```

Or, if you already have a `.fluentci` folder (generated from `fluentci init -t terragrunt`) in your project:
